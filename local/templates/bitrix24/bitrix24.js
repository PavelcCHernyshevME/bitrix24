...
B24.Bitrix24InviteDialog.Init = function(arParams)
{
	...
	BX.ready(BX.delegate(function()
	{
		B24.Bitrix24InviteDialog.popup = BX.PopupWindowManager.create("B24InviteDialog", null, {
			...
			content: '<div style="width:500px;height:550px; background: url(/local/templates/bitrix24/images/loader.gif) no-repeat center;"></div>',
			events: {
				onAfterPopupShow: function()
				{
					this.setContent('<div style="width:500px;height:550px; background: url(/local/templates/bitrix24/images/loader.gif) no-repeat center;"></div>');
					BX.ajax.post(
